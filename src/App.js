...
class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      canvaswidth: 530,
      canvasheight: 620,
      defaultbg:require('./images/img/Fichier 4.png'),
        ...
        <Row className="bottomborder">
          <Col xs="3">
            <nav className="navbar navbar-expand-lg header-bar">
              ...
              <div className="left-link"><a href="{null}" className="nav-link">FinestTailor Editor</a></div>
            </nav>
          </Col>
          <Col>          
            <nav className="navbar navbar-expand-lg header-bar">
          ...
          <Col xs={this.state.rightcolsize}>              
            ...
            <Row>
              ...
              <FabricCanvas state={this.state} updateCanvas={this.updateCanvas} updateState={this.updateState} >
                ...
                <button  onClick={this.downloadAsPNG}>download</button>
              </Col>
            </Row>
          </Col>
        </Row>
