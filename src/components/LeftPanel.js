       ...
       <div className="leftpanelcontent">
        ...
        <TabPanel tabId="vertical-tab-two">
          <Container className="text-editer">
            <Row>
              <Col>                              
                <p className="btn btn-primary" onClick = {this.showUploadPopup}>Upload model</p>
              </Col>
              <Col>
                <p className="btn btn-primary" onClick = {this.deleteCanvasBg}>Remove model</p>
              </Col>
            </Row>
            <Row>
              <Col>
            ...
            <Row>
              <Col>                  
                 <div className="patterns">
                    <p>Models</p>
                    <Draggable type="bgpattern" data={require('../images/216.2/216ppi/Fichier 1.png')}><span className="pattern1" onClick={() => this.applyBGPattern(require('../images/216.2/216ppi/Fichier 1.png'))}></span></Draggable>
                    <Draggable type="bgpattern" data={require('../images/img/Fichier 4.png')}><span className="pattern2" onClick={() => this.applyBGPattern(require('../images/img/Fichier 4.png'))}></span></Draggable>
                    <Draggable type="bgpattern" data={require('../images/216.2/216ppi/Fichier 16.png')}><span className="pattern3" onClick={() => this.applyBGPattern(require('../images/216.2/216ppi/Fichier 16.png'))}></span></Draggable>
